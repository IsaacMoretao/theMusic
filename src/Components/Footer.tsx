...
export function Nav(){
  return(
    <footer className='flex justify-around items-center mt-auto w-full border-t h-[50px]
    bg-black-100'>
      <p>Nome da Musica</p>
      <nav className="flex justify-between items-center w-[150px] ">
        ...
        <div className='p-[18px] rounded-full border border-white-500 bg-white-100 h-[8px] w-[8px]
